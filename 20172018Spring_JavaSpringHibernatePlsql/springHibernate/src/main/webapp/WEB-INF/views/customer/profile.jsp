...
<div class="container">
    ...
    <div class="row" style="margin-top: 10%">
        <div class="col-4">
            ...
            <h6 class="text-info">Floor: <strong><% out.print(profile.getFloor());%></strong></h6>
            <h6 class="text-info">Building: <strong><% out.print(profile.getBuilding());%></strong></h6>
            <h6 class="text-info">Room: <strong><% out.print(profile.getRoom());%></strong></h6>
        </div>
        <div class="col-4">
