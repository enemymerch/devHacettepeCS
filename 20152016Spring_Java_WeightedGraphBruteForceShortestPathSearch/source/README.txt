Algorithm-->
	I didn't choose specific algorithm for finding shortest path , because of mustpass verticies . I thought they could be troubling but i didn't think about complexity. So i choosed to go with brutal search(recursive) and found all the path from SourceVertex to DestinationVertex . Then i tried to use Dijksra's algorithm but it was too late .
